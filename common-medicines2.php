...
if (isset($_POST['add_medicine'])) {
    ...
    $sql = "INSERT INTO medicines (medicine_name, medicine_form, category, strength, updated_at $syncFields) 
    VALUES ('$medicine_name', '$medicine_form', '$category', '$strength', NOW() $syncValues)";
