...
if (isset($_GET['id'])) {
    ...
    $page_title = 'قرار الحقن';
    $confirm_label = '💉 تم إعطاء الإبرة';
    $confirm_action = 'add-injection.php';
    $accent_class = 'injection';
} else {
...
<style>
    .decision-page {
        ...
        background:
            ...
            linear-gradient(135deg, #ecfdf5, #f8fafc 45%, #dbeafe);
    }
    ...
    .decision-card.injection::before {
    ...
    body[data-theme="dark"] .decision-page {
        background:
            radial-gradient(circle at top right, rgba(16, 185, 129, 0.22), transparent 28%),
...
<body class="decision-page">
    ...
    <div class="decision-shell">
        <div class="decision-card <?php echo htmlspecialchars($accent_class, ENT_QUOTES, 'UTF-8'); ?>">
            ...
            <form action="discharge_injection.php" method="post" id="noShowForm">
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                <input type="hidden" name="appointment_id" value="<?php echo $appointment_id; ?>">
                <input type="hidden" name="appointment_date" value="<?php echo htmlspecialchars($appointment_date, ENT_QUOTES, 'UTF-8'); ?>">
