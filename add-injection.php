    ...
    <main class="page">
        ...
        <?php else: ?>
            ...
            <section class="form-panel">
                <div class="form-head">
                    <div>
                        <span class="section-label">نموذج الحقن</span>
                        <h2>تفاصيل جلسة الحقن</h2>
                    </div>
                    <a class="btn" href="add-surgery.php?id=<?= (int) $patient['id'] ?>">إضافة عملية لنفس المريض</a>
                </div>

                <form action="add-injection2.php" method="POST">
                    ...
                    <div class="form-actions">
                        <button class="primary" id="injection_btn" name="injection_btn" type="submit">حفظ الحقن</button>
                    </div>
                </form>
            </section>
        <?php endif; ?>
