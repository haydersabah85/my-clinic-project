    ...
    <div class="ou">
      <div class="od">
        ...
        <div class="od-info">
          ...
          <input type="text" inputmode="decimal" id="iop_od" name="iop_od" value="<?php echo htmlspecialchars($va_row['iop_od'] ?? ''); ?>" placeholder="mmHg" />
        </div>
      ...
      <div class="os">
        ...
        <div class="os-info">
          ...
          <input type="text" inputmode="decimal" id="iop_os" name="iop_os" value="<?php echo htmlspecialchars($va_row['iop_os'] ?? ''); ?>" placeholder="mmHg" />
        </div>
