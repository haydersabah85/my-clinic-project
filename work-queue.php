...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .page { max-width: 1220px; margin: auto; }
        ...
        input, button, .btn { border: 1px solid #d9e2ec; border-radius: 10px; padding: 10px 12px; font-family: inherit; font-weight: 700; }
        button, .btn { background: #1d4ed8; border-radius: 10px; color: #fff; text-decoration: none; cursor: pointer; }
        ...
        .card h2 { margin: 0; padding: 14px 16px; background: #eef6ff; color: #1d4ed8; font-size: 20px; }
        .row { display: grid; grid-template-columns: 1fr auto; gap: 10px; padding: 12px 16px; border-top: 1px solid #eef2f7; align-items: center; }
        ...
        .actions a { color: #fff; background: #0f766e; text-decoration: none; padding: 7px 9px; border-radius: 9px; font-weight: 800; }
